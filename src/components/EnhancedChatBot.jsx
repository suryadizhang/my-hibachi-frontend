...
const EnhancedChatBot = () => {
  ...
  return (
    <div className="enhanced-chatbot-container">
        ...
        <div className={`chatbot-window ${isMinimized ? 'minimized' : ''}`}>
          ...
          <div className="chatbot-header">
            <div className="chatbot-header-info">
              <img src={hibachiLogo} alt="Hibachi Chef" className="chatbot-avatar" />
              ...
              <div className="chatbot-messages">
                {messages.map((msg) => (
                  <div key={msg.id} className={`message ${msg.type}`}>
                    {msg.type === 'bot' && (
                      <img src={hibachiLogo} alt="Bot" className="message-avatar" />
                    )}
      ...
      >
        <img src={hibachiLogo} alt="Chat" className="chatbot-fab-icon" />
        {!isOpen && (
