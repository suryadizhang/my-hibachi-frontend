  ...
  "🍱 Menu & Upgrades": [
    {
      ...
      body: (
        <>
          ...
          • <strong>Premium Angus Sirloin St           header: "I haven't received a confirmation email after paying the deposit?",
      body: (
        <>
          If you paid via our website, you should receive a confirmation email from cs@myhibachichef.com. If you used a payment link provided by our team, there will be no email, but don't worry—our customer service team checks payments daily and will reach out to confirm.
        </>
      )  <>
          If you paid via our website, you should receive a confirmation email from cs@myhibachichef.com. If you used a payment link provided by our team, there will be no email, but don't worry—our customer service team checks payments daily and will reach out to confirm.
        </>dy: (
      ...
      )       If you paid via our website, you should receive a confirmation email from cs@myhibachichef.com. If you used a payment link provided by our team, there will be no email, but don't worry—our customer service team checks payments daily and will reach out to confirm.</strong>: Premium USDA choice beef cooked to your preferred temperature<br />
